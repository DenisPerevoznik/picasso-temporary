...
exports.RedKiteService = void 0;
const common_1 = require("@nestjs/common");
const axios_1 = require("@nestjs/axios");
const rxjs_1 = require("rxjs");
let RedKiteService = class RedKiteService {
    constructor(httpService) {
        this.httpService = httpService;
        this.url = 'https://redkite-api.polkafoundry.com/pools/v3/upcoming-pools';
    }
    getData() {
...
RedKiteService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService])
], RedKiteService);
exports.RedKiteService = RedKiteService;
//# sourceMappingURL=red-kite.service.js.map